  ...
  <body>
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                <div class="col-md-3">
                    <?php require_once('inc/sidebar_comment.php');?>
                </div>
                <div class="col-md-9">
                    <h1><i class="fa fa-comment"></i> comment <small>View All comment</small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                      <li class="active"><i class="fa fa-comment"></i> comment</li>
                    </ol>
                    <?php
                    if(isset($_GET['reply'])){
                        $reply_id = $_GET['reply'];
                        ...
                        if(mysqli_num_rows($reply_check_run) > 0){
                            if(isset($_POST['reply'])){
                                ...
                                if(empty($comment_data)){
                                    ...
                                    $insert_comment_query = "INSERT INTO `comment` (date,name,username,post_id,email,image,comment,status) VALUES ('$date','$full_name','$session_username','$reply_id','$email','$image','$comment_data','approve')";
