...
<?php require_once('inc/header.php');?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-pencil"></i> Edit Book <small>Edit Book Details</small></h1><hr>
                    <ol class="breadcrumb">
                      <li><a href="index.php"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                      <li class="active"><i class="fa fa-pencil"></i> Edit Book</li>
                    </ol>
                    <?php
                    if(isset($_POST['update'])){
                        ...
                        if(empty($up_title) or empty($up_post_data) or empty($up_tags) or empty($up_image)){
                            ...
                            if(mysqli_query($con, $update_query)){
                                $msg = "Book Has Been Udated";
                                $path = "img/$up_image";
                                header("location: edit-book.php?edit=$edit_id");
                                if(!empty($up_image)){
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <input type="submit" class="btn btn-primary" value="Update Book" name="update">
                            </form>
                        </div>
                    </div>
                </div>
