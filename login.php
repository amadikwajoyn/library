...
<html lang="en">
  <head>
    ...
    <title>Login | BluntGist@ ADMIN</title>
  ...
  <body background= "img/scholem-rr.png">

    <div class="container">

      <form class="form-signin animated shake" action="" method="post">
        <h2 class="form-signin-heading">Virtual Library@ Login</h2>
      ...
      <form class="form-signin animated shake" action="..\index.php" method="post">

        <input type="submit" name="submit" value="Home" class="btn btn-lg btn-primary btn-block">
      </form>
