...
<?php require_once('inc/header.php');?>
        ...
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1><i class="fa fa-plus-square"></i> Add Book <small>Add New Book</small></h1><hr>
                    <ol class="breadcrumb">
...
if(isset($_POST['submit'])){
    ...
    if(empty($title) or empty($post_data) or empty($tags) or empty($image)){
        ...
        $insert_query = "INSERT INTO `posts` (date,title, author,author_image,image,category,tags,post,views,status, thumb) VALUES ('$date','$title','$session_username','$session_author_image','$image','$categories','$tags','$post_data','0','$status', '0')";
                ...
                <div class="col-xs-12">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            ?>
<input type="text" name="title" placeholder="Type Book Title Here" value="<?php if(isset($title)){echo $title;}?>" class="form-control">
</div>

<div class="form-group">
    <a href="media.php" class="btn btn-primary" data-toggle="popover" data-placement="left" title="Add media">Add Media</a>
</div>
