...
if(isset($_GET['del'])){
    ...
    if($_SESSION['role'] == 'admin'){
        ...
        $del_check_query = "SELECT * FROM `posts` WHERE id = $del_id and user = '$session_username'";
        $del_check_run = mysqli_query($con, $del_check_query);
    }
    if(mysqli_num_rows($del_check_run) > 0){
        ...
        if(mysqli_query($con, $del_query)){
            ...
            $error = "Book has not been deleted";
        } 
    }
    else{
  ...
  <body>
    <div id="wrapper">
        ...
        <div class="container-fluid body-section">
            <div class="row">
                <div class="col-md-3">
                    <?php require_once('inc/sidebar_book.php');?>
                </div>
                <div class="col-md-9">
                    <h1><i class="fa fa-file"></i> Books <small>View All Books</small></h1><hr>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-tachometer"></i> Dashboard</a></li>
                      <li class="active"><i class="fa fa-file"></i> Books</li>
                    </ol>
                    <?php
                    if($_SESSION['role'] == 'admin'){
                        ...
                        $query = "SELECT * FROM posts WHERE user = '$session_username' ORDER BY id DESC";
                        $run = mysqli_query($con, $query);
                    }
                        ...
                        <div class="col-sm-8">
                                <div class="row">
                                    ...
                                    <div class="col-xs-8">
                                        ...
                                        <a href="add-book.php" class="btn btn-primary">Add New</a>
                                    </div>
                                </div>
                        </div>
                    </div>
                           ...
                           <?php
                            ...
                            <tr>
                               <td><input type="checkbox" class="checkboxes" name="checkboxes[]" value="<?php echo $id;?>"></td>
                                ...
                                <td><a href="edit-book.php?edit=<?php echo $id;?>"><i class="fa fa-pencil"></i></a></td>
                                <td><a href="books.php?del=<?php echo $id;?>"><i class="fa fa-times"></i></a></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
